...
$this->setFrameMode(true);
 ?>
    <a class="article-back-btn"  style="display:inline-block;" href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>">
...
<?endif;?>
<style>
.article-back-btn:hover {color: #FF8126; }
.article-back-btn svg {margin-bottom: -4px;}
</style>