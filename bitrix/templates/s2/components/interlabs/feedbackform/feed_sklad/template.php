        ...
        <div class="body">
            ...
            <form method="post" enctype="multipart/form-data" action=""
                ...
                foreach ($arResult['FIELDS'] as $code => $field) { ?>
                    <div class="form-group <?if ($code=='name'):?>name-feed<?endif?>">
                        <?php
                        switch ($field['TYPE']) {
                            case 'file[]':
                                ?>
                            ...
                            default:
								...
								<?if ($code=='sklad'):?>              
                                <input type="hidden"  id="<?php echo $code; ?>" name="<?php echo $code; ?>"
                ...
                <?php } ?>
<p required="">
							 Нажимая кнопку "Отправить" вы соглашаетесь с <a href="/about/politika-konfidentsialnosti/" target="_blank">политикой конфиденциальности</a>
						</p>
                <div class="form-group">
